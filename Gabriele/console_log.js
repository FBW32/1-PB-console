...
let vorName = "Angela";
let nachName = "Merkel";
let job = "German Chancellor";
let jobCity = "Berlin";
let background = "chemistry";
console.log(vorName, nachName, job, jobCity, background);
...
console.log(vorName + " " + nachName + " was born in West Germany in 1954, Merkel was raised in a small East German town to the north of " + jobCity + "." + " She is currently the " + job + ". " + "Her headquarters are placed in Berlin. " + "When she was young she studied " + background + ". ");